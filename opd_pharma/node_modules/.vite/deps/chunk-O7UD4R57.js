...
var mergeProps = __name2((slotProps, childProps) => {
...
__name2(concatAriaDescribedby, "concatAriaDescribedby");
var SlotContext = React2.createContext(mergeProps);
SlotContext.displayName = "SlotContext";
var SlotProvider = __name2(({ children, mergeProps: mergeProps2 }) => {
  return (0, import_jsx_runtime.jsx)(SlotContext.Provider, { value: mergeProps2, children });
}, "SlotProvider");
function createSlot(ownerName) {
  const Slot2 = React2.forwardRef((props, forwardedRef) => {
    const context = React2.useContext(SlotContext);
...
//# sourceMappingURL=chunk-O7UD4R57.js.map
